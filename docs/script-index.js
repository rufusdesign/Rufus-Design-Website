...
window.addEventListener("DOMContentLoaded", () => {
    ...
    /* ------------------------
       MOBILE: skip video, reveal immediately
    ------------------------- */
    if (isMobile) {
...
// GALLERY MODAL //
  const galleryData = {
      ...
      'item-A41': [
        { src: 'Images/ALL WORKS/**A_Yawaragi/JAL_1.webp', artworktitle: '「yawaragi」', caption: 'Slide 1/6' },
        { src: 'Images/ALL WORKS/**A_Yawaragi/JAL_2-1.webp', artworktitle: '「yawaragi」', caption: 'Slide 2/6' },
        { src: 'Images/ALL WORKS/**A_Yawaragi/JAL_2-2.webp', artworktitle: '「yawaragi」', caption: 'Slide 3/6' },
        { src: 'Images/ALL WORKS/**A_Yawaragi/JAL_2-3.webp', artworktitle: '「yawaragi」', caption: 'Slide 4/6' },
        { src: 'Images/ALL WORKS/**A_Yawaragi/JAL_2-4.webp', artworktitle: '「yawaragi」', caption: 'Slide 3/6' },
        { src: 'Images/ALL WORKS/**A_Yawaragi/JAL_2-5.webp', artworktitle: '「yawaragi」', caption: 'Slide 4/6' },
      ],
      // Add more as needed...
};
...
/* scheduleReveal is now called inside the DOMContentLoaded handler above.
   The lines below are no longer needed and have been commented out.
*/
...
wrapper.addEventListener('scroll', () => {
  if (!lastInputWasWheel) targetScroll1 = wrapper.scrollTop;
});
